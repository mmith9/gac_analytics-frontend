import { DatacronCC, TeamCC, UnitCC } from "./data_classes";

export function addUnitToTeam(newUnit: UnitCC, team: TeamCC | null) {
...
export function removeUnitFromTeam(unitToRm: UnitCC, team: TeamCC | null) {
    let newTeam = copyTeam(team)
...
export function copyTeam(team: TeamCC | null):TeamCC|null {
    if (team === null) {return null}
    return {...team}
}

export function addDatacronToTeam(datacron:DatacronCC, team: TeamCC | null)
{
    let newTeam = copyTeam(team)
